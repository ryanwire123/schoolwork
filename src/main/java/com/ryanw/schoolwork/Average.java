...
public class Average {
    public static void main(String[] args) {
        ...
        // input https://data-flair.training/blogs/read-java-console-input/
        ...
        for (int i = 0; i < x; i++) {
            ...
            // break line into string array https://www.geeksforgeeks.org/split-string-java-examples/
        ...
        for (int i = 0; i < x; i++) {
            ...
            // output string https://www.baeldung.com/java-printstream-printf
